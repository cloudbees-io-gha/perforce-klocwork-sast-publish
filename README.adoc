...
| Boolean
| No
| Enable Klocwork Local Scan.

| `build-project-options`
| String
| No
| Klocwork build project analysis command options.

| `load-result-options`
| String
| No
| Klocwork scan load results command options.
    ...
    steps:
      ...
      - id: klocwork-step
        ...
        with:
          ...
          token: ${{ secrets.KLOCWORK_APP_TOKEN }}
          username: ${{ vars.KLOCWORK_USERNAME }}
          build-directory: ${{ vars.KLOCWORK_BUILD_DIR }}
          build-tool: ${{ vars.KLOCWORK_BUILD_TOOL }}
          build-options: ${{ vars.KLOCWORK_BUILD_OPS }}
...
[source, yaml,role="default-expanded"]
----
name: Perforce Klocwork scan workflow
